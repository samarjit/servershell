...
import com.ycs.fe.exception.DataTypeException;
 ...
 public static enum DataType { 
         STRING,INT,DATEDDMMYYYY,FLOAT,DOUBLE, TIMESTAMP, DATE_NS, LONG ,DATE_TIME_MIN_FORMAT
 } 
 ...
 public String getTypeString() { 
	 ...
	 if(type == DataType.DATE_NS)
		 return "DATE_NS"; 
	 if(type == DataType.DATE_TIME_MIN_FORMAT)
		 return "DATE_TIME"; 
 ...
 public static DataType getDataTypeFrmStr(String type) throws DataTypeException{
	 ...
	 if(type.equals("DATE_TIME") )
		 return DataType.DATE_TIME_MIN_FORMAT; 
