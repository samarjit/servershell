...
<script>
  ...
  function calljqgrid(formdata){
   jQuery("#listid").jqGrid( {
      	...
      	{name: 'balatreporting', index: 'balatreporting' , width:88, editable:true },
      	{name: 'spentaftreporttrans', index: 'spentaftreporttrans' , width:88, editable:true },
      	{name: 'spentaftreportnontrans', index: 'spentaftreportnontrans' , width:88, editable:true },
      	{name: 'balatblocking', index: 'balatblocking' , width:88, editable:true },
      	{name: 'cardstatus', index: 'cardstatus' , width:160, editable:true },
      	{name: 'cardinsureavail', index: 'cardinsureavail' , width:11, editable:true },
      	{name: 'inspolicyno', index: 'inspolicyno' , width:138, editable:true },
      	{name: 'refundmode', index: 'refundmode' , width:160, editable:true },
      	{name: 'replacecardno', index: 'replacecardno' , width:176, editable:true },
      	{name: 'refundexpirydate', index: 'refundexpirydate' , width:138, editable:true },
      	{name: 'refundstatus', index: 'refundstatus' , width:240, editable:true },
      	{name: 'blockedby', index: 'blockedby' , width:200, editable:true },
      	{name: 'reportingtime', index: 'reportingtime' , width:138, editable:true },
      	{name: 'blockingtime', index: 'blockingtime' , width:138, editable:true },
      	...
      	{name: 'policereportduedate', index: 'policereportduedate' , width:138, editable:true },
      	{name: 'insamountclaimed', index: 'insamountclaimed' , width:88, editable:true },
      	...
      	{name: 'totalmisusedamount', index: 'totalmisusedamount' , width:88, editable:true },
      	{name: 'unsyncsettled', index: 'unsyncsettled' , width:11, editable:true },
      	...
      	{name: 'insurresult', index: 'insurresult' , width:138, editable:true },
      	...
      	{name: 'updatedate', index: 'updatedate' , width:138, editable:true },
      	{name: 'updatedby', index: 'updatedby' , width:160, editable:true },
      	{name: 'rejectreason', index: 'rejectreason' , width:400, editable:true },
      	{name: 'emailnotified', index: 'emailnotified' , width:11, editable:true },
      	{name: 'sawtxnref', index: 'sawtxnref' , width:160, editable:true },
      	{name: 'insurfilerecvdate', index: 'insurfilerecvdate' , width:138, editable:true },
      	{name: 'sawfilerecvdate', index: 'sawfilerecvdate' , width:138, editable:true },
      	{name: 'mtrfilerecvdate', index: 'mtrfilerecvdate' , width:138, editable:true },
      	{name: 'replacecardnotmp', index: 'replacecardnotmp' , width:176, editable:true }
      	],
      	rowNum: 15,
      	rowList: [ 15, 25, 50],
      	pager: '#pagerid',
...
<form name="form1" id="form1" method="post" action="${pageContext.request.contextPath}/html/simpleform.action?screenName=CardBlockRefund">
        	 <table>
        	   ...
        	   <tr><td>Update Date </td><td><s:property value="#resultDTO.data.formonload[0].updatedate"  /></td></tr>
        	   <tr><td>Updated By </td><td><s:property value="#resultDTO.data.formonload[0].updatedby"  /></td></tr>
        	   <tr><td>Reject Reason </td><td><s:property value="#resultDTO.data.formonload[0].rejectreason"  /></td></tr>
        	   <tr><td>Email Notified </td><td><s:property value="#resultDTO.data.formonload[0].emailnotified"  /></td></tr>
        	   <tr><td>Saw Txn Ref </td><td><s:property value="#resultDTO.data.formonload[0].sawtxnref"  /></td></tr>
        	   <tr><td>Insur File Recv Date </td><td><s:property value="#resultDTO.data.formonload[0].insurfilerecvdate"  /></td></tr>
        	   <tr><td>Saw File Recv Date </td><td><s:property value="#resultDTO.data.formonload[0].sawfilerecvdate"  /></td></tr>
        	   <tr><td>Mtr File Recv Date </td><td><s:property value="#resultDTO.data.formonload[0].mtrfilerecvdate"  /></td></tr>
        	   <tr><td>Replace Card No Tmp </td><td><s:property value="#resultDTO.data.formonload[0].replacecardnotmp"  /></td></tr>
        	 </table>
